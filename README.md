...
RF03
RF04
O sistema deve identificar clientes pelo CPF e verificar fidelidade
O sistema deve aplicar desconto de 15% para clientes com fidelidade
O sistema deve emitir cupom fiscal simplificado ao finalizar a venda
RF05
RF06
O sistema deve exibir o estoque disponível por loja
O sistema deve alertar quando um produto atingir o estoque mínimo
RF07
O sistema deve gerar relatório de giro de produtos por loja
...
RNF05
Requisito
O sistema deve ser desenvolvido em Java com Orientação a Objetos
O sistema deve utilizar encapsulamento com getters e setters
O sistema deve utilizar exceções customizadas para tratamento de erros
O sistema deve utilizar arrays para armazenamento de dados
A interface do sistema deve ser via terminal (Scanner)
RNF06
O sistema deve ser de fácil operação pelo atendente no caixa
Stack Tecnológica
